<?php
  ...
  define("MY_EMAIL", "Youremail@example.com");
   ...
   */
  function setMessageBody ($name, $subject, $message) {
  ...
  include_once 'library/vender/securimage/securimage.php';
  ...
  if(mail(MY_EMAIL, "Medicure Pulse contact Enquiry", setMessageBody($_POST["name"], $phone, $message), "From: $email")) {
